...
![Picture of an Eisenhower matrix: vertical axis titled "Importance", horizontal axis titled "Urgency", and four quadrants titled "Do now", "Schedule", "Delegate", and "Eliminate".](/images/posts/eisenhower-matrix.png)
