...
![Screenshot of a Linux terminal available from ChromeOS.](/images/posts/chromeos-linux-terminal.png)
...
![Screenshot of Linux home directory available in ChromeOS file manager.](/images/posts/chromeos-linux-files.png)

To share files in another direction, there's a handy "Share with Linux" option for files:

![Screenshot of "Share with Linux" option in ChromeOS file manager.](/images/posts/chromeos-share-with-linux.png)
...
![Screenshot of Linux folders shared with ChromeOS.](/images/posts/chromeos-linux-shared-folders.png)
