...
![A screenshot from "The Simpsons" of a man smacking his forehead. The text reads "My goodness, what an idea! Why didn't I think of that".](/images/posts/what-an-idea.png)
...
![A chart with a USD to CFA exchange rate chart with exchange rate per 1 USD staying roughly within 400-600 CFA.](/images/posts/usd-to-cfa.png)
